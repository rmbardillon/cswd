    ...
    <div class="d-flex align-items-start">
        ...
        <div id="id" class="p-3" style="height: 240px;width: 365px;">
            <div class="row" style="margin-bottom: -16px;">
                ...
                <div class="col col-2" id="pdao-icon"><img id="pdao" src="assets/img/PDAO.png" width="50px" height="50px" style="padding-right: 3px;"></div>
            </div>
            ...
            <div class="row">
                <div class="col"><img src="assets/img/PDAO%20icon.png" width="36" height="38"></div>
                <div class="col text-center">
                    <div id="signature1" style="padding-top: 0px;padding-bottom: 0px;margin-bottom: -32px;"><img src="assets/img/sig1.png" width="50px" style="margin-bottom: 0px;padding-top: 0px;margin-top: -30px;padding-bottom: 0px;"></div><strong style="font-size: 7px;">MARITES M. TIONGCO, Phd</strong>
                    <p style="font-size: 6px;padding-bottom: 0px;padding-top: 0px;margin-top: -6px;">PDAO Officer-in-Charge</p>
                </div>
                <div class="col text-center">
                    <div id="signature2" style="margin-bottom: -30px;"><img src="assets/img/sig2.png" width="50px" style="margin-top: -22px;"></div><strong style="font-size: 7px;">HON. ARLENE B. ARCILLAS</strong>
